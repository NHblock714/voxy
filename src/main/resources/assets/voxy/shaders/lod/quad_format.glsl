...
//Bit 63 marks a quad whose biome field holds a blend-palette index (border voxels only); the
//index is 13 bits: 9 in the biome field + 4 in the otherwise-unused bits 42-45
